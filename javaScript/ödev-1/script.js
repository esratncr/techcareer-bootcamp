...
var result = soru1(products);
console.log("Fiyatı 30 ile 100 arasında olan ürün sayısı: " + result)



var sonsoru = products.reduce(function(minProduct, product) {
    return (product.price < minProduct.price) ? product : minProduct;
  }, products[0]);
  
  console.log("En ucuz ürün: " + sonsoru.name);

  

  var soru4 = products.find(function(product) {
    return product.id === 10;
  });
  
  if (soru4) {
    console.log("Id'si 10 olan ürünün adı: " + soru4.name);
  } else {
    console.log("Id'si 10 olan ürün bulunamadı.");
  }
